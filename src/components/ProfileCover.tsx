...
import {Platform, StatusBar, TouchableOpacity, StyleSheet, ImageSourcePropType, Image} from 'react-native';
...
class ProfileCover extends Component<ProfileCoverProps> {
    ...
    render() {
        ...
        const source: ImageSourcePropType = DefaultProfileCover;
        return (
            <TouchableOpacity
                activeOpacity={1}
                onPress={this.openCover}
                style={{borderBottomWidth: 0, borderColor: 'lightgrey'}}>
                <ImageComponent
                    source={source}
                    style={s.cover}
