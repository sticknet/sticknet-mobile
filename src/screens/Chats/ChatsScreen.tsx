...
import {groups, auth, app, users, stickRoom, notifications, common, iap, create, vault} from '@/src/actions';
import {
    SearchBar,
    Sticknet,
    Icon,
...
import type {IApplicationState, TUser, TGroup, TConnectionRequest, TParty, TMessage} from '@/src/types';
