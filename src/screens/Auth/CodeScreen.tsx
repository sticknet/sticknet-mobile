...
import PrivacyIcon from '@expo/vector-icons/SimpleLineIcons';
...
import {auth, app} from '@/src/actions/index';
...
import type {IAuthActions, IAppActions} from '@/src/actions/types';
