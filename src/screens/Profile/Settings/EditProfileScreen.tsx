...
import {Input, Image, DatePicker, BottomModal, ModalItem, NewImage} from '@/src/components';
import {profile, create, auth, app} from '@/src/actions/index';
import {photosPermission} from '@/src/utils';
import {globalData} from '@/src/actions/globalVariables';
import type {IApplicationState, TUser, TImage, TProfilePicture, TProfileCover} from '@/src/types';
