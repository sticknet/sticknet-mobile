...
import CalendarIcon from '@expo/vector-icons/AntDesign';
import FeatherIcon from '@expo/vector-icons/Feather';
import MCIcon from '@expo/vector-icons/MaterialCommunityIcons';
import AsyncStorage from '@react-native-async-storage/async-storage';
import {nav, parseBirthDay, shortenAddress} from '@/src/utils';
import {auth, users, groups, app, profile, common, iap, stickRoom, create, vault} from '@/src/actions';
import {ProfilePicture, ProfileCover, Icon, StorageMeter, ActionButton} from '@/src/components';
...
import {IStickRoomActions, ICommonActions} from '@/src/actions/types';
